...
let deferredPrompt = null; // untuk install PWA
...
async function init() {
  ...
  // Cek status install, jika sudah terinstall sembunyikan tombol
  if (isAppInstalled()) {
...
// Deteksi jika app dijalankan dalam mode standalone (sudah terinstall)
